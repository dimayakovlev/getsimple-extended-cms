	...
	<div id="maincontent">
		<div class="main">
			...
			<table class="highlight healthcheck">
				...
				if ($verstatus == '0') {
					$ver = '<span class="ERRmsg" ><b>'.$site_version_no.'</b><br /> '. i18n_r('UPG_NEEDED').' (<b>'.$apikey->latest .'</b>)<br /><a href="https://github.com/dimayakovlev/getsimple-extended-cms/releases">'. i18n_r('DOWNLOAD').'</a></span>';
				} elseif ($verstatus == '1') {
					...
					$ver = '<span class="WARNmsg" ><b>'.$site_version_no.'</b><br />'. i18n_r('CANNOT_CHECK').'<br /><a href="https://github.com/dimayakovlev/getsimple-extended-cms/releases">'. i18n_r('DOWNLOAD').'</a></span>';
				}
				?>
