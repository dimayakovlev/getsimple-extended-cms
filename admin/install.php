...
?>
	...
	<h3><?php echo $site_full_name .' '. i18n_r('INSTALLATION'); ?></h3>
			...
			if ($verstatus == '0') {
				$ver = '<span class="ERRmsg" >'. i18n_r('UPG_NEEDED') .' <b>'.$apikey->latest .'</b><br /><a href="<?php echo $site_link_back_url; ?>" target="_blank" >'. i18n_r('DOWNLOAD').'</a></span>';
			} elseif ($verstatus == '1') {
				...
				$ver = '<span class="WARNmsg" >'. i18n_r('CANNOT_CHECK') .' <b>'.$site_version_no.'</b><br /><a href="<?php echo $site_link_back_url; ?>" target="_blank" >'. i18n_r('DOWNLOAD').'</a></span>';
			}
			?>
