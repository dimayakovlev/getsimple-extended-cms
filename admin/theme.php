	...
	<div id="maincontent">
		...
		<?php
			...
			if (file_exists('../theme/' . $TEMPLATE . '/images/screenshot.png')) {
				...
				echo '<p><img id="theme-preview" style="visiblity:hidden;" src="../' . $theme_path . $TEMPLATE . '/images/screenshot.png" alt="' . i18n_r('THEME_SCREENSHOT') . '"></p>';
				echo '<span id="theme-no-img"><p><em>' . i18n_r('NO_THEME_SCREENSHOT') . '</em></p></span>';
			}
