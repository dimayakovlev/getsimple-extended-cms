...
if ($sitemap !== true) {
	...
	if (isset($_GET['refresh'])) $success = i18n_r('SITEMAP_REFRESHED');
}
...
<div class="bodycontent">
	<div id="maincontent">
		<div class="main">
			...
			<div class="unformatted"><code><?php if (file_exists('../sitemap.xml')) echo htmlentities(formatXmlString(file_get_contents('../sitemap.xml'))); ?></code></div>
		</div>
	</div>
