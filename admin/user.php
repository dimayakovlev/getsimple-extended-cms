    ...
    <div id="maincontent">
        <div class="main">
            ...
            <form class="largeform" action="changedata.php" method="post" accept-charset="utf-8">
                ...
                <div class="leftsec">
                    <p><label for="user"><?php i18n('LABEL_USERNAME');?>:</label><input name="user" type="text" readonly value="<?php echo $USR; ?>"></p>
                </div>
                <div class="rightsec">
                    <p><label for="email"><?php i18n('LABEL_EMAIL');?>:</label><input name="email" type="email" value="<?php echo $datau->email; ?>"></p>
                    <?php
                ...
                <p><?php i18n('ONLY_NEW_PASSWORD'); ?>:</p>
                <div class="leftsec">
                    <p>
